...
/**
 * A <code>JSplitPane</code> like component that devides its area into two components
 * and allows adjustment of layout through mouse drag.
 */
public class Slice extends JPanel {
     ...
     * 
     * @param remainder  remainder component
     */
     ...
     * 
     * @param orientation  position of main component, SwingConstants.TOP,
    ...
    /**
     * Set the weight of the main component, i.e. how much available space
     * is assigned to the main component.
     * 
     * @param weight    weight
     */
     ...
     * 
     * @param child     child to get other component for
    ...
    private class SliceLayout extends MouseInputAdapter implements LayoutManager {   
        ...
        public void layoutContainer(Container parent) {
            ...
            if (main != null && main.isVisible() && remainder != null && remainder.isVisible()) {
                ...
                } else if (orientation == SwingConstants.LEFT || orientation == SwingConstants.RIGHT) {
                    width -= spacing;
